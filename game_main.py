...
while True:
	...
	for event in pygame.event.get():
		...
		if event.type == pygame.MOUSEBUTTONDOWN:
			...
			elif(160 <=mouse[0] and mouse[0] <=300 and 200 <=mouse[1]and mouse[1]<=240):
				os.system('python3 baghchal.py')
			elif(160 <=mouse[0] and mouse[0] <=300 and 250 <=mouse[1]and mouse[1]<=290):
				os.system('python3 reverse_baghchal.py')
			elif(160 <=mouse[0] and mouse[0] <=300 and 200 <=mouse[1]and mouse[1]<=340):
				pygame.quit()
